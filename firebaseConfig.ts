...
export const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || "AIzaSyADuDCD5J5k8TxRVwkpdKKZtIHkODv__tM",
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || "whimsyyy-sns.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "whimsyyy-sns",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "whimsyyy-sns.firebasestorage.app",
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "894638916604",
  appId: import.meta.env.VITE_FIREBASE_APP_ID || "1:894638916604:web:6640cb68b9c61718f0a879",
  measurementId: import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || "G-MSLJR98FVR"
};
